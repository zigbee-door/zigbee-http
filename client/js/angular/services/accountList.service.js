...
angular.module("webapp")
    .service("accountListService",["$http","$q",accountListService]);

function accountListService($http,$q){
    ...
    return{
        ...
        modifyAccount:function(params){
            return handlerRequest('POST','/accountList/modify',params);
        },
        deleteAccount:function(params){
            return handlerRequest('POST','/accountList/delete',params);
        }
    }
}
